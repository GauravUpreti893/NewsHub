      ...
      <div id="big" className="container-fluid px-0 pb-4">
        <div id="aboutcontainer" className="container d-flex flex-row pt-4">
          ...
          <div className=" d-flex flex-column align-items-center px-5 pt-5 pb-3" style={mode === 'Dark Mode' ? { backgroundColor: "#F8F9FA", color: "#212529" } : { backgroundColor: "#1F1F1F", color: "white" }}>
            ...
            <a className="btn btn-primary px-2" href='https://github.com/GauravUpreti893' target="_blank" rel="noopener noreferrer">Github Link  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-github mx-1" viewBox="0 0 16 16">
